...
const Dashboard = () => {
    const { data, loading, error } = useGetProfile(`http://localhost:5000/api/v1/doctors/profile/me`);
                        ...
                        <div className="lg:col-span-2">
                            {data && data.isApproved === 'pending' && (
                                <div className="flex p-4 mb-4 text-yellow-800 bg-yellow-50 rounded-lg">
                                    ...
                                    <div>
                                        Hãy hoàn tất các thông tin để được xét duyệt. Chúng tôi sẽ kiểm tra và xét duyệt trong vòng ba ngày tới
                                    </div>
                                </div>
                            )}
                            {/* Hiển thị nội dung khác tùy thuộc vào tab */}
                            <div className="mt-8">
                                {tab === 'overview' && <div>
                                    <div className="flex items-center gap-4 mb-10">
                                        <figure className="max-w-[200px] max-h-[200px]">
                                            <img src={data.photo} className="w-full" alt="day là ah" />
                                        </figure>
                                        <div>
                                            ...
                                            <div className="flext items-center gap-[6px]">
                                            ...
                                            <p className="text__para font-[15px] lg:max-2-[390px] leading-6">{data.bio}</p>
                                        </div>
                                    </div>
